...
# you can reference a CSV file stored in a GitHub repository in your Streamlit app. To do this, you can use the raw file URL from GitHub. Here are the steps:
# 1. Get the Raw URL of the CSV File
# 	•	Navigate to the CSV file in your GitHub repository.
# 	•	Click on the Raw button at the top of the file view.
# 	•	Copy the URL from the browser

DATA_URL = "https://raw.githubusercontent.com/DanCacic/datasets-master-/refs/heads/main/store_sales_2022-2023.csv"
